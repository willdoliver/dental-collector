...
class SearchPoints():
    ...
    def get_brazil_search_points(self):
        ...
        clustered_grid_points = SearchPoints.generate_clustered_grid_points(min_latitude, max_latitude, min_longitude, max_longitude, interval, num_clusters)
        map_center = [-14.2350, -51.9253]  # Approximate center of Brazil
        mymap = folium.Map(location=map_center, zoom_start=4)

        brazil_points = SearchPoints.point_is_in_brazil(clustered_grid_points)
        # print(brazil_points)
    ...
    def point_is_in_brazil(points):
        ...
        brazil_borders = gpd.read_file("C:/Users/m41586/Downloads/ne_10m_admin_0_countries/ne_10m_admin_0_countries.shp")
        brazil_points = []
