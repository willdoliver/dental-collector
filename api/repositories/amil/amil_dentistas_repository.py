...
class DentistaOrm(Base):
    __tablename__ = os.getenv("AMIL_TABLE_DENTISTAS")

    id = Column(BigInteger, primary_key=True, autoincrement=True)
    nome_dentista = Column(String(220), nullable=False)
    nome_fantasia = Column(String(220), nullable=False)
    cro = Column(String(16), primary_key=True, nullable=False)
    uf = Column(String(2), primary_key=True, nullable=False)
    email = Column(String(220), default=None)
